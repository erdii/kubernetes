		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"fieldValidation": {
						SchemaProps: spec.SchemaProps{
							Description: "fieldValidation instructs the server on how to handle objects in the request containing unknown or duplicate fields. Valid values are: - Ignore: ignores unknown/duplicate fields. - Warn: warns about unknown/duplicate fields without failing. - Strict: fails on unknown/duplicate fields.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"createOnly": {
						SchemaProps: spec.SchemaProps{
							Description: "CreateOnly indicates that the apply should only succeed if it creates a new object. If the object already exists, the request will fail with a Conflict error. When both CreateOnly and Force are set to true, the request will fail with a BadRequest error as these options are mutually exclusive.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
